...
def get_descendants_0_getargs() :  #TEST 1
    return [net_basic, 'A']
...
def get_descendants_1_getargs() :  #TEST 2
    return [net_dsep, 'D']
...
def get_descendants_2_getargs() :  #TEST 3
    return [net_dsep, 'B']
...
def get_descendants_3_getargs() :  #TEST 4
    return [net_dsep, 'E']
...
def get_descendants_4_getargs() :  #TEST 5
...
def get_nondescendants_0_getargs() :  #TEST 6
    return [net_basic, 'A']
...
def get_nondescendants_1_getargs() :  #TEST 7
    return [net_basic, 'C']
...
def get_nondescendants_2_getargs() :  #TEST 8
    return [net_dsep, 'F']
...
def get_nondescendants_3_getargs() :  #TEST 9
    return [net_dsep, 'E']
...
def get_nondescendants_4_getargs() :  #TEST 10
    return [net_dsep, 'D']
...
def get_nondescendants_5_getargs() :  #TEST 11
    return [net_disjoint, 'A']
...
def remove_nondescendants_0_getargs() :  #TEST 12
...
def remove_nondescendants_1_getargs() :  #TEST 13
...
def remove_nondescendants_2_getargs() :  #TEST 14
...
def remove_nondescendants_3_getargs() :  #TEST 15
...
def probability_lookup_0_getargs() :  #TEST 16
...
def probability_lookup_1_getargs() :  #TEST 17
...
def probability_lookup_2_getargs() :  #TEST 18
...
def probability_lookup_3_getargs() :  #TEST 19
...
def probability_lookup_4_getargs() :  #TEST 20
...
def probability_joint_0_getargs() :  #TEST 21
...
def probability_joint_1_getargs() :  #TEST 22
...
def probability_joint_2_getargs() :  #TEST 23
...
def probability_marginal_0_getargs() :  #TEST 24
...
def probability_marginal_1_getargs() :  #TEST 25
...
def probability_marginal_2_getargs() :  #TEST 26
...
def probability_marginal_3_getargs() :  #TEST 27
    return [net_racoon, dict(B=False, R=False, D=True, T=False, C=True)]
...
def probability_conditional_0_getargs() :  #TEST 28
...
def probability_conditional_1_getargs() :  #TEST 29
...
def probability_conditional_2_getargs() :  #TEST 30
    return [net_racoon, {'D':False}, {'B':True, 'R':False}]
...
def probability_conditional_3_getargs() :  #TEST 31
    return [net_racoon, dict(B=False, R=False, D=True, T=False, C=True)]
...
def probability_0_getargs() :  #TEST 32
    return [net_racoon, {'B':False}]
...
def probability_1_getargs() :  #TEST 33
    return [net_racoon, {'D':True}, dict(B=True, R=False, T=False)]
...
def probability_2_getargs() :  #TEST 34
    return [net_racoon, {'D':False}]
...
def probability_3_getargs() :  #TEST 35
    return [net_racoon, {'T':True, 'C':False}]
...
def probability_4_getargs() :  #TEST 36
    return [net_racoon, {'B':True, 'R':True}, {'D':False, 'T':False}]
...
def probability_5_getargs() :  #TEST 37
    return [net_racoon, {v:False for v in 'BRDTC'}]
...
def probability_6_getargs() :  #TEST 38
    return [net_racoon, dict(B=False, R=False, D=True, T=False, C=True)]
...
def number_of_parameters_0_getargs() :  #TEST 39
    return [net_basic]
...
def number_of_parameters_1_getargs() :  #TEST 40
...
def number_of_parameters_2_getargs() :  #TEST 41
    return [net_dsep]
...
def number_of_parameters_3_getargs() :  #TEST 42
...
def independent_0_getargs() :  #TEST 43
...
def independent_1_getargs() :  #TEST 44
...
def independent_2_getargs() :  #TEST 45
...
def independent_3_getargs() :  #TEST 46
...
def independent_4_getargs() :  #TEST 47
...
def independent_5_getargs() :  #TEST 48
...
def independent_6_getargs() :  #TEST 49
...
def independent_7_getargs() :  #TEST 50
