...
def calculate_error_rates_2_getargs() :  #TEST 4
    return [{"0" : F(1,8), "1": F(1,8), "2": F(1,8), "3": F(1,8), "4": F(1,2)}, {"classifier_0":["0", "1", "4"], "classifier_1":["0", "1", "2", "3"]}]
...
def get_overall_misclassifications_0_getargs() :  #TEST 16
    return [[("h1", 1)], ['A','B'], {'h1':['A','B'],'h2':['A']}]
get_overall_misclassifications_0_expected = ['A', 'B']
...
#H misclassifies A
def get_overall_misclassifications_1_getargs() :  #TEST 17
    return [[("h1", 1),("h2", 0)], ['A','B'], {'h1': ['A'], 'h2': ['B']}]
get_overall_misclassifications_1_expected = ['A']
...
# H misclassifies A & B
def get_overall_misclassifications_2_getargs() :  #TEST 18
    return [[("h1", .5),("h2", .3),("h3", .76)], ['A','B','C','D'],
             {'h1': ['A'], 'h2': ['A','B'], 'h3': ['B','C']}]
get_overall_misclassifications_2_expected = ['A', 'B']
...
#H misclassifies C
def get_overall_misclassifications_3_getargs() :  #TEST 19
    return [[("h1", .5),("h2", -.3),("h3", .76)], ['A','B','C'],
             {'h1': ['A','C'], 'h2': ['A','B'], 'h3': []}]
get_overall_misclassifications_3_expected = ['C']
...
def get_overall_misclassifications_4_getargs() :  #TEST 20
    return [[("h1", -.5),("h2", -.3),("h3", -.45)], ['A','B','C','D'],
             {'h1': ['A','C'], 'h2': ['B','C'], 'h3': ['D']}]
get_overall_misclassifications_4_expected = ['A', 'B', 'D']
...
def get_overall_misclassifications_5_getargs() :  #TEST 21
    return [[("h1", -0.549),("h2", 0.347),("h1", -0.255)], list('ABCD'),
             dict(h1=list('ABC'), h2=list('AC'), h3=list('BC'))]
get_overall_misclassifications_5_expected = ['D']
...
def get_overall_misclassifications_6_getargs() :  #TEST 22
    return [[("h1", 0.5), ("h2", 0.5)], ['A','B'],
             {'h1': ['A'], 'h2': []}]
get_overall_misclassifications_6_expected = ['A']
...
def get_overall_misclassifications_7_getargs() :  #TEST 23
    return [[("h1", 0.5), ("h2", 0.2), ("h3", 0.2)], list('ABCD'),
             {'h1': ['A'], 'h2': ['B'], 'h3': ['C']}]
get_overall_misclassifications_7_expected = ['A']
...
def is_good_enough_0_getargs() :  #TEST 24
...
def is_good_enough_1_getargs() :  #TEST 25
...
def is_good_enough_2_getargs() :  #TEST 26
    return [[("h1", .5),("h2", .3),("h3", .76)], ['A','B','C','D'],
...
def is_good_enough_3_getargs() :  #TEST 27
    return [[("h1", .5),("h2", -.3),("h3", .76)], ['A','B','C'],
             {'h1': ['A','C'], 'h2': ['A','B'], 'h3': []}, 1]
...
def is_good_enough_4_getargs() :  #TEST 28
    return [[("h1", -.5),("h2", -.3),("h3", -.45)], ['A','B','C','D'],
...
#misclassified training point is not listed in misclassifications
#same classifier used multiple times
def is_good_enough_5_getargs() :  #TEST 29
    return [[("h1", -0.549),("h2", 0.347),("h1", -0.255)], list('ABCD'),
...
#one point misclassified, vote is a tie
# (No, this particular situation would not happen in Adaboost.)
def is_good_enough_6_getargs() :  #TEST 30
    return [[("h1", 0.5), ("h2", 0.5)], ['A','B'],
             {'h1': ['A'], 'h2': []}, 0]
...
#violates triangle sum property
def is_good_enough_7_getargs() :  #TEST 31
    return [[("h1", 0.5), ("h2", 0.2), ("h3", 0.2)], list('ABCD'),
             {'h1': ['A'], 'h2': ['B'], 'h3': ['C']}, 0]
...
def update_weights_0_getargs() :  #TEST 32
...
def update_weights_2_getargs() :  #TEST 33
...
def update_weights_3_getargs() :  #TEST 34
...
#1 round
def adaboost_0_getargs() :  #TEST 35
...
#2 rounds
def adaboost_1_getargs() :  #TEST 36
...
#3 rounds
def adaboost_2_getargs() :  #TEST 37
...
def adaboost_3_getargs() :  #TEST 38
...
def adaboost_4_getargs() :  #TEST 39
...
def adaboost_5_getargs() :  #TEST 40
...
def adaboost_6_getargs() :  #TEST 41
...
def adaboost_7_getargs() :  #TEST 42
...
def adaboost_8_getargs() :  #TEST 43
...
def adaboost_9_getargs() :  #TEST 44
...
def adaboost_91_getargs() :  #TEST 45
...
def adaboost_92_getargs() :  #TEST 46
    return [list('ABCDEFG'),
